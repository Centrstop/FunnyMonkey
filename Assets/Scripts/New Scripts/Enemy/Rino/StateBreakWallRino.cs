...
{
    [CreateAssetMenu(menuName = "State/Enemy/Rino/StateBreakWallRino")]
    public class StateBreakWallRino : BaseStateEnemy
    {
        public float timeInState = 0.0f;
        public StateBreakWallRino(Enemy enemy, IEnemyStateSwitcher stateSwitcher) : base(enemy, stateSwitcher)
        {
            nameState = "isBreakWall";
        }
